...
hfsvol *hfs_mount(const wchar_t *, int, int);
...
int hfs_zero(const wchar_t *, unsigned int, unsigned long *);

//int hfs_mkpart(const char *, unsigned long);
int hfs_mkpart(const wchar_t *, unsigned long);

//int hfs_nparts(const char *);
int hfs_nparts(const wchar_t *);

//int hfs_format(const char *, int, int, const char *, unsigned int, const unsigned long []);
int hfs_format(const wchar_t *, int, int, const char *, unsigned int, const unsigned long[]);
